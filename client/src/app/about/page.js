      ...
      <main className="flex-1 w-full max-w-4xl mx-auto p-6 flex flex-col gap-12 animate-in fade-in duration-700">
        ...
        <section className="text-center space-y-6 py-10">
          ...
          <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
            A minimalist tool to manage poker chips for your home games. No
            sign-ups, no downloads, just a browser and your friends.
          </p>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-green-500/30 transition shadow-lg">
            ...
            <p className="text-slate-400 leading-relaxed">
              Forget downloading huge apps. Riffle runs entirely in your web
              browser. It works perfectly on iPhones, Androids, Tablets, and
              Laptops.
            </p>
          </div>
          ...
          <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-green-500/30 transition shadow-lg">
            ...
            <p className="text-slate-400 leading-relaxed">
              Powered by WebSockets, every bet, raise, and fold happens
              instantly on everyone's screen. No refreshing required.
            </p>
          </div>
          ...
          <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-green-500/30 transition shadow-lg">
            ...
            <p className="text-slate-400 leading-relaxed">
              We don't ask for your email, phone number, or credit card. Rooms
              are temporary and exist only in memory while you play.
            </p>
          </div>
          ...
          <div className="bg-slate-800 p-8 rounded-2xl border border-slate-700 hover:border-green-500/30 transition shadow-lg">
            ...
            <p className="text-slate-400 leading-relaxed">
              No more arguing over pot size. The app tracks every chip,
              calculates side pots (coming soon), and ensures accurate betting.
            </p>
          </div>
        </section>
        ...
        <section className="py-8 border-t border-slate-800">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            <div className="flex gap-4 items-start">
              <span className="flex-shrink-0 w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center font-bold text-sm">
                1
              </span>
              <p className="text-slate-300 pt-1">
                One person clicks <strong>Create Table</strong> and gets a
                4-letter Room Code.
              </p>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <p className="text-slate-300 pt-1">
                Friends open the site, click <strong>Join</strong>, and enter
                that code.
              </p>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <p className="text-slate-300 pt-1">
                Everyone gets 1,000 chips. Start betting!
              </p>
            </div>
          </div>
        </section>
